...
const NavbarTop = () => {
  ...
  const navHeight = "top-[45px]"; // Adjust this value to match your navbar's height exactly
  ...
  return (
    ...
    <div className="bg-white font-sans shadow lg:shadow-none text-black py-1 md:py-0 border-b sticky top-0 z-50">
      {/* ======= DESKTOP NAV ======= */}
      ...
      <div
        className={`fixed inset-0 ${navHeight} bg-black/40 backdrop-blur-sm z-40 transition-opacity duration-300 ${
      ...
      <div
        className={`fixed ${navHeight} left-0 bottom-0 w-1/2 bg-white shadow-2xl z-50 transform transition-transform duration-500 ease-in-out overflow-y-auto border-r ${

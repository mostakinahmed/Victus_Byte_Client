  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="px-6 py-3 flex-1 space-y-1">
          {/* Home */}
          <div
            onClick={() => handleNavigate("/")}
            className="flex items-center justify-between py-3 border-b border-slate-200 font-bold text-slate-800 text-sm cursor-pointer hover:text-[#FF751F] transition-colors duration-200"
          >
            <span>Home</span>
          </div>
          ...
          <div className="border-b border-slate-200">
            ...
            >
              ...
              <div
                className={`w-6 h-6 rounded-full bg-slate-200/80 flex items-center justify-center text-black/90 transition-transform duration-300 ${
                ...
                <div className="pb-3 pl-4 flex flex-col space-y-2 pt-1">
                  {catData?.map((cat, idx) => (
                    <span
                      ...
                      className="text-sm font-medium text-black/80 hover:text-[#FF751F] cursor-pointer py-1 flex items-center gap-2 border-b border-slate-50 last:border-none transition-all duration-200 hover:translate-x-1"
                    >
          ...
          <div className="py-4">
            ...
            <div className="grid grid-cols-3 gap-2">
              ...
              <div
                ...
                className="group cursor-pointer rounded-2xl border border-slate-100 bg-white p-3 text-center shadow-xs transition-all duration-300 hover:-translate-y-1 hover:border-[#FF751F]/30 hover:bg-orange-50 hover:shadow-lg"
              >
                <div className="mx-auto mb-2 flex h-10 w-10 items-center justify-center rounded-xl bg-orange-50 text-xl transition-all duration-300 group-hover:bg-[#FF751F] group-hover:scale-110">
                  🧸
                </div>

                <span className="block text-[12px] font-semibold text-black/80 transition-colors duration-300 group-hover:text-[#FF751F]">
                  Kids Zone
                </span>

                <ChevronRight
                  size={12}
                  className="mx-auto mt-1 text-slate-300 transition-all duration-300 group-hover:translate-x-1 group-hover:text-[#FF751F]"
                />
              </div>
              ...
              <div
                ...
                className="group cursor-pointer rounded-2xl border border-slate-100 bg-white p-3 text-center shadow-sx transition-all duration-300 hover:-translate-y-1 hover:border-[#FF751F]/30 hover:bg-orange-50 hover:shadow-lg"
              >
                <div className="mx-auto mb-2 flex h-10 w-10 items-center justify-center rounded-xl bg-orange-50 text-xl transition-all duration-300 group-hover:bg-[#FF751F] group-hover:scale-110">
                  👜
                </div>
          ...
          <div className="pt-4 space-y-2">
            ...
            <div
              ...
              className="group flex items-center justify-between px-4 py-3 rounded-xl border border-slate-200 bg-slate-100 hover:bg-orange-50 hover:border-[#FF751F]/30 cursor-pointer transition-all duration-300 hover:translate-x-1"
            >
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 rounded-lg bg-white border border-slate-200 flex items-center justify-center text-sm group-hover:bg-[#FF751F] group-hover:text-white group-hover:border-[#FF751F] transition-all duration-300">
                  ⇄
                </div>

                <div>
                  <span className="block text-sm font-bold text-black/80 group-hover:text-[#FF751F] transition-colors">
                    Compare Products
                  </span>
                </div>
              </div>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <span className="block text-sm font-bold text-slate-700 group-hover:text-[#FF751F] transition-colors">
                    Special Offers
                  </span>
                </div>
              </div>
          ...
          <div className="mt-8 space-y-3 pt-4">
            ...
            <div className="flex items-center gap-3 text-sm text-slate-600">
              ...
              <span className=" font-bold">09611-342936</span>
            </div>
          </div>
        ...
        {/* Social Footer */}
        <div className="px-6 py-3 border-t border-slate-100 flex items-center justify-center gap-4 bg-slate-50">
          {[
            {
            ...
            <a
              key={idx}
              href={item.link}
              className="w-9 h-9 rounded-full border border-slate-400 flex items-center justify-center text-slate-600 hover:bg-[#FF751F] hover:text-white hover:border-[#FF751F] transition-all duration-300 hover:-translate-y-1 hover:shadow-md"
            >
              {item.icon}
            </a>
          ))}

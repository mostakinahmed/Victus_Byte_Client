...
const Header = () => {
  ...
  return (
    <>
      <header
        className={`fixed font-sans top-0 w-full md:h-9 h-7 bg-slate-900 text-slate-300 flex items-center px-4 z-50 transition-transform duration-1000 ease-in-out ${

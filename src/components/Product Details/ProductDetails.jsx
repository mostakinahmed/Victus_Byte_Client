          ...
          <div className="flex-1 bg-white border border-slate-200 p-3 md:p-5 rounded flex flex-col justify-between">
            <div>
              ...
              <div className="flex flex-wrap items-center justify-between  md:justify-start gap-1.5 md:gap-5 mb-4 md:mb-7">
                ...
                <span className="bg-slate-100 text-slate-600 text-[10px] md:text-[11px] md:tracking-wider font-bold px-2 py-0.5 rounded uppercase border border-slate-200">
                  Code:{" "}
                  <span className="text-[#fe741d] md:text-[12px]">
                    {product.pID}
                  </span>
                </span>
              </div>
          ...
          `}
                ...
                <div className="select-none mt-4">
                  ...
                  <div className="flex gap-5">
                    <div className="group flex items-center bg-slate-100  p-1 rounded-2xl w-fit border border-slate-200/60 shadow-inner">
                      {/* Decrease Button */}
                      <button
                        disabled={quantity <= 1}
                        onClick={() => setQuantity(quantity - 1)}
                        className=" w-7  h-7 flex items-center justify-center rounded-xl bg-white shadow text-slate-600 transition-all duration-200 
                 ...
                 disabled:opacity-40 disabled:cursor-not-allowed"
                      ...
                      <div className="w-14 flex flex-col items-center justify-center overflow-hidden">
                        <span
                          key={quantity}
                          className="md:text-lg text-md font-medium text-slate-900 tabular-nums animate-in fade-in zoom-in duration-300"
                        >
                          {quantity}
                        </span>
                      </div>

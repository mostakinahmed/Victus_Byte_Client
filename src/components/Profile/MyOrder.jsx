                  ...
                  >
                    ...
                    <td className="md:px-6 px-4 py-3">
                      <div className="flex flex-col">
                        ...
                        <span className="text-[10px] uppercase font-medium text-slate-600 tracking-tighter">
          ...
          {selectedOrder && (
            <div className="fixed inset-0 z-[999] flex items-center justify-center p-4 backdrop-blur-sm bg-slate-900/20">
              <motion.div
                ...
                className="bg-white w-full max-w-2xl max-h-[90vh] border-1 border-[#1976d2] overflow-y-auto rounded-xl shadow-2xl relative scrollbar-thin scrollbar-thumb-slate-200"
              >
                {/* Modal Header */}

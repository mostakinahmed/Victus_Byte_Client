      ...
      <form onSubmit={handleSubmit} className="max-w-md space-y-6">
        ...
        <div className="flex items-center gap-4 mt-8">
          <button
            type="submit"
            disabled={loading}
            className="bg-[#1976d2] text-white px-10 py-3 rounded font-bold text-xs uppercase tracking-widest hover:bg-[#1565c0] transition-all active:scale-95 disabled:bg-slate-300 shadow-lg shadow-blue-100"
          >
